...
#   warranty.
#
#   Local changes: Have the output go into splint/ dir.  Also move
#                  .PHONY targets which were annoying automake.
#                  Lastly define some targets even when splint
#                  isn't configured.  --kevin@ie.suberic.net
...
define splint_rules
splint-out/\$(1)_splint.log: \$${AX_DOLLAR}(\$(1)_OBJECTS)
